        ...
        var DocumentViewerDemoApp = /** @class */ (function () {
            function DocumentViewerDemoApp() {
                ...
                this.beforeServiceHeartbeat = function (sender, args) {
                    ...
                    if (lt.Document.DocumentFactory.cancelFromPrepareAjax(_this, "DocumentViewerDemoApp", "Heartbeat", settings)) {
                        // Cancel this request
                        args.cancel = true;
                    }
                    else {
            ...
            DocumentViewerDemoApp.prototype.browserPageSetup = function () {
                 ...
                 *    - Do nothing, and wait for the default license check in Leadtools.Controls (using LTHelper.licenseDirectory)
                 *    - lt.RasterSupport.setLicenseUri(licenseUri, callback)
                 *       - Allows us to set an absolute or relative path to the license file (makes a GET request)
                 *    - lt.RasterSupport.setLicenseText(licenseText)
                 *       - Allows us to make our own request for the license and just provide the text
                 *
            ...
            DocumentViewerDemoApp.prototype.Init = function () {
                ...
                this.loadingDlg.show(false, false, "Verifying Service Connection...", null, function () {
                    // The Document Library contains properties to set that will connect to the Documents service.
            ...
            Object.defineProperty(DocumentViewerDemoApp.prototype, "hookPrepareAjax", {
                ...
                set: function (value) {
                    if (value && this._prepareAjaxEventHandler == null) {
                        ...
                        this._prepareAjaxEventHandler = lt.Document.DocumentFactory.prepareAjax.add(DocumentViewerDemoApp.prepareAjaxHandler);
                    }
            ...
            DocumentViewerDemoApp.prototype.initDocumentViewer = function () {
                ...
                imageViewer.activeItemChanged.add(function () {
                    _this._editPart.updateCurrentPageNumber();
                });
                if (this.useElements) {
                    this.updateUseCSSTransitions();
            ...
            DocumentViewerDemoApp.prototype.showServiceError = function (message, jqXHR, statusText, errorThrown) {
                ...
                var serviceMessage;
                var showAlert = true;
                if (!serviceError.isParseError && !serviceError.isBrowserError && !!serviceError.methodName && !!serviceError.exceptionType) {
                    var parts = [];
                    ...
                    if (serviceError.isParseError || serviceError.isBrowserError) {
                        ...
                        serviceMessage = "The request failed for an unknown reason. Check the connection to the Documents Service.";
                    }
                }
                if (showAlert) {
            ...
            DocumentViewerDemoApp.prototype.doPrint = function (options) {
                ...
                this.loadingDlg.show(true, true, "Preparing for print...", null, function () {
                    options.parent = _this._printElement;
                    ...
                    _this._documentViewer.print(options)
                        ...
                        //if (data && data.options && !data.options.autoOpenBrowserPrint)
                        //   this._documentViewer.openBrowserPrint(data.options.parent, data.root, data.options.title, data.printStyles);
                    })
                        .fail(function (err) {
                    ...
                    this.loadingDlg.show(false, false, "Loading Document...", "Verifying Document", function () {
                        ...
                        lt.Document.DocumentFactory.checkCacheInfo(documentUri)
                            ...
                            if (!cacheInfo || cacheInfo.isMimeTypeAccepted) {
                                ...
                                _this.loadFromUri(documentUri, annotations, loadEmbeddedAnnotations, documentName);
                            }
                            else {
            ...
            DocumentViewerDemoApp.prototype.loadFromUri = function (documentUri, annotations, loadEmbeddedAnnotations, documentName) {
                var _this = this;
            ...
            DocumentViewerDemoApp.prototype.uploadDocument = function (documentFile, annotationsFile, loadEmbeddedAnnotations) {
                ...
                this.loadingDlg.show(true, true, "Uploading Document...", null, function () {
                    var uploadPromise = lt.Document.DocumentFactory.uploadFile(documentFile);
                    ...
                    var queryDone = function (statusJobData) {
                        ...
                        if (statusJobData.errorMessages && statusJobData.errorMessages.length) {
                            ...
                            lt.Document.Converter.StatusJobDataRunner.deleteConvertJob(userToken, jobToken)
                                ...
                                .always(function () {
                                _this.endBusyOperation();
                                _this.exportJobDlg.show(statusJobData);
