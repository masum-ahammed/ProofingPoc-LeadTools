...
namespace DocumentsService.Areas.HelpPage
{
   ...
   public interface ICustomDocumentationProvider
   {
   ...
   /// </summary>
   public class XmlDocumentationProvider : IDocumentationProvider, IModelDocumentationProvider, ICustomDocumentationProvider
   {
